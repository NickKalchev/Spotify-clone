import { HomeIcon, SearchIcon, PlusCircleIcon, RssIcon, HeartIcon, LogoutIcon } from '@heroicons/react/outline';
...
function Sidebar() {
    ...
    return (
        <div className="text-gray-500 p-5 text-xs sm:text-base border-r border-gray-900 overflow-y-scroll
            h-screen scrollbar-hide sm:max-w-[12rem] lg:max-w-[15rem] hidden md:flex flex-col">
